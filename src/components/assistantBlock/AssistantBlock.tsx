...
const quiz = [
  {
    ...
    options: ['Отличную кожу', 'Улучшить здоровье', 'Улучшить кожу глаз',
      'Сохранить молодость', 'Шикарные волосы', 'Уменьшить морщины'],
  ...
  },
  {
    ...
    options: ['до 30 минут в день', '1 час в день',
      '2 часа в день', '2-3 часа в день', 'Любое время'],
...
export const AssistantBlock: React.FunctionComponent = () => {
  ...
  return (<div className={styles.assistantBlock}>
